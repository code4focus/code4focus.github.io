...
- Поддержка SEO, Sitemap, OpenGraph, RSS, MDX, LaTeX, Mermaid и TOC
- i18n поддержка
...
- [PageSpeed Insights (desktop)](https://pagespeed.web.dev/analysis?url=https%3A%2F%2Fcode4focus.github.io%2F&form_factor=desktop) для текущей главной страницы GitHub Pages.
