...
| `user/code4focus` as the personal integration branch | `repo-specific` | This branch line reflects the current maintainer workflow rather than a universal convention. | Adopters should rename this to their own stable integration branch. | `user/code4focus` |
